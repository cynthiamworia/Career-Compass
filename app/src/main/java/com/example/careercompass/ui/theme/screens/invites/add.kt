...
@Composable
fun AddInvitesScreen(navController:NavHostController){
    ...
    )
    {
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Job Name*", color = Color(0xFFEC2BE9)) },textStyle = TextStyle(color = Color(0xFFFFFFFF)),
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Interview Date *", color = Color(0xFFEC2BE9)) },textStyle = TextStyle(color = Color(0xFFFFFFFF)),
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Company Name *",color = Color(0xFFEC2BE9))  },textStyle = TextStyle(color = Color(0xFFFFFFFF)),
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
...
fun AddProductsScreenPreview(){
    CareerCompassTheme {
        AddInvitesScreen(navController = rememberNavController())
    }
}