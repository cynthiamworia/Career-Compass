...
@Composable
fun AddResourcesScreen(navController:NavHostController){
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Resource  Name *",color = Color(0xFFFFFFFF)) },
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Resource Providers *",color = Color(0xFFFFFFFF)) },
            textStyle = TextStyle(color = Color(0xFFFFFFFF)),
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
...
fun AddProductsScreenPreview(){
    CareerCompassTheme {
        AddResourcesScreen(navController = rememberNavController())
    }
}